...
// This file implements the computation of timestep embeddings using CUDA.
// Timestep embeddings provide the model with information about the current step in the diffusion process.
