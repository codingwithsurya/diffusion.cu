...
// This file contains the testing framework for the UNet diffusion model using CUDA.
// It includes functions for loading model parameters, running forward and backward passes, and validating results.
